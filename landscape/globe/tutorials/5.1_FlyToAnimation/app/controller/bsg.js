/////////////////initialize 'global' variables			
	...
	BSG.variables.text="In Position";
	
	
	//namespaces for utilities	
	BSG.util={
		flyToAnimationStarted:function (context)
		{
		   BSG.variables.text = "Moving";
		},
		//------------------------------------------------------------------------------
		// Callback wich will be called as soon the target position is reached
		positionReached:function (context)
		{
		   BSG.variables.text = "In Position";
		},		
		OnKeyDown:function(ctx,key)
		{
